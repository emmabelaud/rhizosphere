...
```{r}
# Data import
habitat_data_raw <- read.csv("../data/distance_data_cleaned.csv") %>%
  mutate(
...
RF_plot
tiff("../output/2.randomforest_plot.tiff", width=6000, height=3000, res=400)
print(RF_plot)
dev.off()
```
...
webshot("../output/S1_table_rf_results.html",
