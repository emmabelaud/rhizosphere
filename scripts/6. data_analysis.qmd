...
df_raw <- habitat_data_raw %>%
  mutate(mature = (distance_root_mature_obs-distance_root_mature_mean_exp)/distance_root_mature_sd_exp,
    growth = (distance_root_growth_obs - distance_root_growth_mean_exp) / distance_root_growth_sd_exp
  ) %>%
