...
Soil temperature et humidity, and daily amplitudecalculation
...
habitat_data <- habitat_data %>%   
  left_join(root_density %>% select(date, position, depth, orientation, root_cm2_count, root_growth_cm2_count, root_mature_cm2_count,root_growth_cm2_count_24h), 
...
```{r}
write.csv(habitat_data, "../output/distance_data_cleaned.csv", row.names = FALSE)
```
