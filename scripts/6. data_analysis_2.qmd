...
habitat_data_long <- habitat_data_raw %>%
  ...
  mutate(across(c(root_cm2_count, root_growth_cm2_count_24h, temp, hum), ~ as.numeric(scale(.x)))) %>%
  select(image_name, temp, hum, period, depth, position, Predicted.class.levelup, root_cm2_count,
