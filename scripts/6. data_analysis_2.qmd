...
### *Defining the rhizosphere influence zone*

To identify the precise spatial extent of root influence, we model animal density as a function of distance using GAMs. We incorporate a geometric correction (log-area offset) to account for the increasing soil volume available at greater distances from the root. The RIZ tipping point is defined as the distance where the first derivative of the model plateau, indicating that the root's influence on animal density has vanished.
...
rhizo_stats_table %>%
  ...
  kbl(caption = "Identification of the Rhizosphere Influence Zone (RIZ) through derivative analysis of animal density gradients",
