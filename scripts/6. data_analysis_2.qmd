...
p1
tiff("../output/1.zscore_distribution.tiff", width = 1800, height = 1700, res = 300)
p1
dev.off()
```
...
t1 <- rhizo_stats_table %>%
  ...
  kbl(caption = "Identification of the rhizosphere width through derivative analysis of animal density gradients", booktabs = TRUE, align = "c", format = "html",escape = FALSE,digits = 2) %>%
...
p2
tiff("../output/3.geometric_constraint.tiff", width = 1800, height = 1700, res = 300)
p2
dev.off()
```
