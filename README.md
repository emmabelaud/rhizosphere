...
The data required to generate the results can be temporarily downloaded at the following link: [dataverse repository]([https://entrepot.recherche.data.gouv.fr/dataset.xhtml?persistentId=doi:10.57745/9VMCNE](https://doi.org/10.57745/9VMCNE).
